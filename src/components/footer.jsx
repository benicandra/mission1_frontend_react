...
const Footer = () => { return (
<footer
  className="bg-gray-50 border-t border-gray-200 py-12 px-4 md:px-[120px]"
>
  <div
  ...
  >
    ...
    <div
      className="w-full grid grid-cols-1 sm:grid-cols-3 gap-8 mt-8 md:mt-0 md:w-1/2"
    >
      <FooterAccordion title="Kategori" links={[ 'Digital & Teknologi',
      'Pemasaran', 'Manajemen Bisnis', 'Pengembangan Diri', 'Desain', ]} />
      <FooterAccordion title="Perusahaan" links={[ 'Tentang Kami', 'FAQ',
